...
dag_id = "stg_ramco_sftp_employee_dag"
...
def sftp_ramco_ingestion():
    ...
    def list_sftp_files():
        ...
        try:
            ...
            remote_dir = sftp_cfg["directory"]["employee"]
            file_prefix = env_cfg["nfs"]["directories"]["ramco"]["file_prefix"]
    ...
    def copy_to_nfs(files: list):
        ...
        try:
            ...
            nfs_cfg = env_cfg["nfs"]["directories"]["ramco"]
    ...
    trigger_bronze_dag = TriggerDagRunOperator(
        ...
        trigger_dag_id="bz_ramco_stg_employee_dag",
...
sftp_ramco_ingestion_dag = sftp_ramco_ingestion()
