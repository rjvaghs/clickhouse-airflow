...
@dag(
    dag_id="deploy_da_productivity_clickhouse_sink_dag",
...
def deploy_da_productivity_clickhouse_sink():
...
deploy_da_productivity_clickhouse_sink_dag = deploy_da_productivity_clickhouse_sink()
