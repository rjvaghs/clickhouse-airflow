...
@dag(
    dag_id="pause_vehicle_productivity_clickhouse_sink_dag",
...
def pause_vehicle_productivity_clickhouse_sink():
...
pause_vehicle_productivity_clickhouse_sink_dag = pause_vehicle_productivity_clickhouse_sink()
