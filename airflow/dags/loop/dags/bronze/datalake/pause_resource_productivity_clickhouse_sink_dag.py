...
@dag(
    dag_id="pause_resource_productivity_clickhouse_sink_dag",
...
def pause_resource_productivity_clickhouse_sink():
...
pause_resource_productivity_clickhouse_sink_dag = pause_resource_productivity_clickhouse_sink()
