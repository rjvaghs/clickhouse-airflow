...
@dag(
    dag_id="pause_shopper_productivity_clickhouse_sink_dag",
...
def pause_shopper_productivity_clickhouse_sink():
...
pause_shopper_productivity_clickhouse_sink_dag = pause_shopper_productivity_clickhouse_sink()
