...
@dag(
    dag_id="deploy_shopper_productivity_clickhouse_sink_dag",
...
def deploy_shopper_productivity_clickhouse_sink():
...
deploy_shopper_productivity_clickhouse_sink_dag = deploy_shopper_productivity_clickhouse_sink()
