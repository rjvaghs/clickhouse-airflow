...
@dag(
    dag_id="pause_da_productivity_clickhouse_sink_dag",
...
def pause_da_productivity_clickhouse_sink():
...
pause_da_productivity_clickhouse_sink_dag = pause_da_productivity_clickhouse_sink()
