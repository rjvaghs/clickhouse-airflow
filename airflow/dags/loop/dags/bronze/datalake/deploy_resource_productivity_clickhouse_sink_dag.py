...
@dag(
    dag_id="deploy_resource_productivity_clickhouse_sink_dag",
...
def deploy_resource_productivity_clickhouse_sink():
...
deploy_resource_productivity_clickhouse_sink_dag = deploy_resource_productivity_clickhouse_sink()
