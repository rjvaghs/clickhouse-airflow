...
@dag(
    dag_id="deploy_resource_level_productivity_sink_dag",
    start_date=datetime.now() - timedelta(days=1),
    schedule=None,
    default_args=default_args,
    catchup=False,
    tags=["kafka-connect", "resource-level", "productivity", "deployment"],
)
def deploy_resource_level_productivity_sink():
...
deploy_resource_level_productivity_sink_dag = deploy_resource_level_productivity_sink()