...
@dag(
    dag_id="pause_resource_level_productivity_clickhouse_sink_dag",
    start_date=datetime.now() - timedelta(days=1),
    schedule=None,
    default_args=default_args,
    catchup=False,
    tags=["kafka-connect", "resource-level", "productivity", "pause"],
)
def pause_resource_level_productivity_clickhouse_sink():
    ...
    def pause_connector():
        ...
        name = "resource_level_productivity"
...
pause_resource_level_productivity_clickhouse_sink_dag = pause_resource_level_productivity_clickhouse_sink()
