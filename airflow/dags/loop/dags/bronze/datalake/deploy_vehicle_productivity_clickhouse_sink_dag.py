...
@dag(
    dag_id="deploy_vehicle_productivity_clickhouse_sink_dag",
...
def deploy_vehicle_productivity_clickhouse_sink():
...
deploy_vehicle_productivity_clickhouse_sink_dag = deploy_vehicle_productivity_clickhouse_sink()
