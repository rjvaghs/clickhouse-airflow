...
@dag(
    dag_id="deploy_fc_productivity_clickhouse_sink_dag",
...
def deploy_fc_productivity_clickhouse_sink():
...
deploy_fc_productivity_clickhouse_sink_dag = deploy_fc_productivity_clickhouse_sink()
