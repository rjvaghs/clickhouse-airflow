...
@dag(
    dag_id="deploy_enterprise_employee_clickhouse_sink_dag",
...
def deploy_enterprise_employee_clickhouse_sink():
...
deploy_enterprise_employee_clickhouse_sink = deploy_enterprise_employee_clickhouse_sink()
