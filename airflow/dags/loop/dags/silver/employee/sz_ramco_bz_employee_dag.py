...
dag_id = "sz_ramco_bz_employee_dag"
...
def bz_to_sz_ramco_employees_transformation():
    ...
    def transform_to_silver(date_range: dict):
        ...
        try:
            ...
            bronze_table = bronze_cfg["tables"]["employee"]
            silver_table = silver_cfg["tables"]["employee"]

            hook = ClickHouseHook(clickhouse_conn_id=clickhouse_conn_id)

            template = jinja_env.get_template("sz_ramco_bz_employee.sql.jinja")
...
bz_to_sz_ramco_employees_transformation = bz_to_sz_ramco_employees_transformation()