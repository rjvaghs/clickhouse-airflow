...
dag_id = "sz_kafka_bz_region_mv_dag"
...
def sz_kafka_bz_region_mv_aggregation():
    ...
    def create_view():
        ...
        template = jinja_env.get_template("mv_sz_region.sql.jinja")
...
sz_kafka_bz_region_mv_aggregation = sz_kafka_bz_region_mv_aggregation()
