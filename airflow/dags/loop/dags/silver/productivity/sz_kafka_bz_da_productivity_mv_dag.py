...
dag_id = "sz_kafka_bz_da_productivity_mv_dag"
...
def sz_kafka_bz_da_productivity_mv_aggregation():
    ...
    def create_view():
        ...
        template = jinja_env.get_template("mv_da_productivity_kpi.sql.jinja")
...
sz_kafka_bz_da_productivity_mv_aggregation = sz_kafka_bz_da_productivity_mv_aggregation()
