...
dag_id = "sz_kafka_bz_shopper_productivity_mv_dag"
...
def sz_kafka_bz_shopper_productivity_mv_aggregation():
    ...
    def drop_view():
        ...
        target_db = "silver"
        table_key = "shopper_productivity"
    ...
    def create_view():
        ...
        template = jinja_env.get_template("mv_shopper_productivity_kpi.sql.jinja")
...
sz_kafka_bz_shopper_productivity_mv_aggregation = sz_kafka_bz_shopper_productivity_mv_aggregation()
