...
dag_id = "sz_resource_productivity_pc_mv_dag"
...
@dag(
    ...
    tags=["clickhouse", "silver", "sz_loop", "aggregation"],
)
def sz_resource_productivity_mv_aggregation():
    ...
    def drop_view():
        ...
        target_db = "silver"
        table_key = "resource_productivity"
        cluster = cfg_loader.load_env_config()["clickhouse"]["cluster"]
        cfg_view = cfg_loader.load_table_config(target_db)
        target_view = cfg_view["views"][table_key]
    ...
    def create_view():
        ...
        template = jinja_env.get_template("mv_sz_resource_productivity_pc.sql.jinja")
...
sz_resource_productivity_mv_aggregation = sz_resource_productivity_mv_aggregation()
