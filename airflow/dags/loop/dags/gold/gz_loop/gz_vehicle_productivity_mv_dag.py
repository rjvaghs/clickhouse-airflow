...
dag_id = "gz_vehicle_productivity_mv_dag"
...
def gz_vehicle_productivity_mv_aggregation():
...
gz_vehicle_productivity_mv_aggregation = gz_vehicle_productivity_mv_aggregation()
