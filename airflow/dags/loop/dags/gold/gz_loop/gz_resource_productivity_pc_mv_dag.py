...
dag_id = "gz_resource_productivity_pc_mv_dag"
...
def gz_resource_productivity_pc_mv_aggregation():
    ...
    def create_view():
        ...
        template = jinja_env.get_template("mv_resource_productivity_pc_kpi.sql.jinja")
...
gz_resource_productivity_pc_mv_aggregation = gz_resource_productivity_pc_mv_aggregation()
