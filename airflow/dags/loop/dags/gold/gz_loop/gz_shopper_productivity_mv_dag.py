...
dag_id = "gz_shopper_productivity_mv_dag"
...
def gz_shopper_productivity_mv_aggregation():
...
gz_shopper_productivity_mv_aggregation = gz_shopper_productivity_mv_aggregation()
